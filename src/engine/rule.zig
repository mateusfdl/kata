...
pub const Predicate = union(PredicateOp) {
    ...
    follows: NestedPredicate,
    not_follows: NestedPredicate,
    precedes: NestedPredicate,
    not_precedes: NestedPredicate,
    between: NestedPredicate,
    not_between: NestedPredicate,
...
fn predicateNeedsMeasures(pred: Predicate) bool {
    return switch (pred) {
        ...
        .between,
        .not_between,
        => |nested| nestedMatcherNeedsMeasures(nested.matcher),
