...
comptime {
    _ = @import("engine.zig");
    _ = @import("baseline_matcher_test.zig");
    ...
    _ = @import("line_index_test.zig");
    _ = @import("match_workspace_test.zig");
    _ = @import("matcher_test.zig");
    _ = @import("metric_cache_test.zig");
    _ = @import("metric_test.zig");
    _ = @import("node_kinds_test.zig");
    _ = @import("node_test.zig");
    _ = @import("open_span_stack_test.zig");
    _ = @import("parse_test.zig");
    _ = @import("query_test.zig");
    _ = @import("root_kind_set_test.zig");
